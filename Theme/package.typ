...
#let cv(
...

  {
    ...
    stack(
      ...
      context {
          show heading.where(level: 2): set text(size: th("heading-font-size"))
  ...
  grid(
    ...
    // Content.
    {
      ...
      set text(fill: th("main-body-color", default: "body-color").lighten(0%))
    ...
    // Aside.
    {
      ...
      set text(fill: th("aside-body-color", default: "body-color").lighten(0%))
  ...
  grid(
    {
      ...
      context {
        set text(fill: text.fill.lighten(0%))
        gutter
      }
    },
    {
